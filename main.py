...
def main():
    ...
    game.hero = Entities.Hero(0,1,2,4,88,'Steve')
    game.monster = Entities.Monster(4,3,5,88,'Fred')
    game.world.placeEntity(1,2,game.hero)
    game.world.placeEntity(4,3,game.monster)
    game.world.placeEntity(3,4,Entities.Key(3,4))
    game.world.placeEntity(5,5,Entities.Gem(5,5,100))
    game.world.placeEntity(7,3,Entities.Shoes(7,3))
    game.world.placeEntity(10,3,Entities.Potion(10,3))
    game.world.placeEntity(12,5,Entities.Exit(,12,5))
